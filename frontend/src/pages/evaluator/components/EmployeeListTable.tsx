      ...
      <table className="table table--hover table--clickable">
        ...
        <thead>
          ...
          <tr>
            ...
            <th className="col-text">{formatMessage({ id: 'common.education' })}</th>
        ...
        <tbody>
          ...
          {employees.map((emp) => (
            ...
            <tr key={emp.id} onClick={() => navigate(profilePath(emp.id))} tabIndex={0}>
              ...
              <td className="cell-muted col-text">{emp.educationLevelName ?? formatMessage({ id: 'common.emptyValue' })}</td>

              <td className="col-meta">

                <span className={`badge ${emp.isActive ? 'badge-approved' : 'badge-draft'}`}>
