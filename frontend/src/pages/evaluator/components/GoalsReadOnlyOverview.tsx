...
export function GoalsReadOnlyOverview({ evaluation }: GoalsReadOnlyOverviewProps) {
  ...
  return (
    ...
    <div className="form-page">
      ...
      {(evaluation.conversationAt || evaluation.evaluatorComment) && (
        ...
        <FormSection title={formatMessage({ id: 'evaluation.conversation' })} variant="secondary">
